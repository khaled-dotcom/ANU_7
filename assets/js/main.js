...
const eventsData = [
  {
    id: 0,
    titleAr: 'استقبال الطلبة الجدد',
    titleEn: 'New Student Orientation',
    descAr: `يسر اتحاد طلاب جامعة الإسكندرية الأهلية أن يرحب بجميع الطلبة الجدد في بداية رحلتهم الجامعية.\n\nيوم التعارف والاستقبال هو فرصتك للتعرف على زملائك الجدد، واكتشاف الأندية والأنشطة الطلابية، والحصول على كل المعلومات التي تحتاجها للبدء بأفضل صورة.\n\nنتمنى لكم رحلة جامعية مليئة بالتميز والنجاح! 🎓`,
    descEn: `Alexandria National University Student Union is pleased to welcome all new students at the beginning of their university journey.\n\nOrientation Day is your chance to meet new classmates, discover student clubs and activities, and get all the information you need to start on the best foot.\n\nWe wish you a university journey full of excellence and success! 🎓`,
    date: '',
    time: '',
...
مع مسابقات خفيفة تجمع بين الترفيه وروح الفريق.`,
  ...
  },
  {
    ...
    descAr: `تنظيم إفطار جماعي لطلاب الجامعة في الحرم الجامعي، تجمع بين أبناء الجامعة على مائدة إفطار واحدة في أجواء رمضانية رائعة، تعزيزاً لالترابط والأخوة بين الطلاب.`,
    descEn: `Hosting a communal iftar dinner for university students on campus, bringing the university family together at one table in a wonderful Ramadan atmosphere to strengthen bonds and brotherhood.`,
    date: '',
    time: '',
    locationAr: 'مقر جامعة الإسكندرية الأهلية',
    locationEn: 'Alexandria National University Campus',
  ...
  {
    id: 33,
    titleAr: 'أعمال خيرية في رمضان',
    titleEn: 'Ramadan Charity Work',
    descAr: `مبادرات خيرية طلابية في شهر رمضان المبارك، تشمل تجهيز وتوزيع وجبات إفطار وكراتين على الأسر المحتاجة، تجسيداً لروح التكافل والمسؤولية المجتمعية لدى طلاب الجامعة.`,
    descEn: `Student charity initiatives during the holy month of Ramadan, including preparing and distributing iftar meals and food baskets to needy families, reflecting the spirit of solidarity and social responsibility among university students.`,
    date: '',
    time: '',
  ...
  {
    id: 34,
    titleAr: 'رحلة القاهرة',
    titleEn: 'Cairo Trip',
    descAr: `رحلة طلابية ترفيهية إلى القاهرة، لزيارة المعالم والمتاحف والأماكن الترفيهية، في إطار برنامج اللجنة الاجتماعية والرحلات لتعزيز روح الفريق بين الطلاب.`,
    descEn: `A recreational student trip to Cairo to visit landmarks, museums and entertainment venues, organized by the Social & Trips Committee to strengthen team spirit among students.`,
    date: '',
    time: '',
    locationAr: 'القاهرة',
    locationEn: 'Cairo',
  ...
  },
  {
    ...
    titleAr: 'رحلة الفيوم',
    titleEn: 'Fayoum Trip',
    descAr: `رحلة ترفيهية جديدة إلى محافظة الفيوم، سحر الطبيعة وثروة المخزون التاريخي في أجواء مليئة بالمتعة والصداقة.`,
    descEn: `A new recreational trip to Fayoum Governorate, the magical nature and historical treasure, in an atmosphere full of fun and friendship.`,
    date: '',
    time: '',
    locationAr: 'الفيوم',
    locationEn: 'Fayoum',
  ...
  {
    id: 36,
    titleAr: 'فريق الجوالة',
    titleEn: 'Scouts Team',
    descAr: `فريق الجوالة بجامعة الإسكندرية الأهلية، يمارس أنشطة الكشافة والجوالة التي تعزز قيم المواطنة والقيادة والخدمة المجتمعية لدى الطلاب.`,
    descEn: `The Scouts team at Alexandria National University carries out scouting activities that strengthen the values of citizenship, leadership and community service among students.`,
    date: '',
    time: '',
    locationAr: 'مقر جامعة الإسكندرية الأهلية',
    locationEn: 'Alexandria National University Campus',
  ...
  {
    id: 37,
    titleAr: 'بطولة تنس الطاولة',
    titleEn: 'Table Tennis Championship',
    descAr: `بطولة تنس الطاولة لطلاب الجامعة، تجمع بين المهارة والتنافس الشريف في أجواء رياضية ممتعة.`,
    descEn: `A table tennis championship for university students, combining skill and fair competition in a fun sports atmosphere.`,
    date: '',
    time: '',
    locationAr: 'مقر جامعة الإسكندرية الأهلية',
    locationEn: 'Alexandria National University Campus',
  ...
  {
    id: 38,
    titleAr: 'أسبوع الشباب في حلوان',
    titleEn: 'Youth Week in Helwan',
    descAr: `مشاركة طلاب جامعة الإسكندرية الأهلية في فعاليات أسبوع الشباب بجامعة حلوان، بمتابعة ودعم قيادة الاتحاد، لتمثيل الجامعة بشكل متميز في هذا الحدث الوطني الكبير.`,
    descEn: `ANU students participated in the Youth Week events at Helwan University, supported by union leadership, representing the university in this major national event.`,
    date: '',
    time: '',
    locationAr: 'جامعة حلوان',
    locationEn: 'Helwan University',
    category: 'events',
    capacity: 0,
    image: 'assets/images/image copy 8.png',
    isPast: true
  },
  {
    id: 39,
    titleAr: 'بطولة البادل',
    titleEn: 'Padel Championship',
    descAr: `بطولة البادل الجامعية، جمعت بين طلاب الجامعة في تنافس رياضي رائع، وأجواء مليئة بالحماس وروح الفريق.`,
    descEn: `University padel championship bringing students together in exciting sporting competition with a great atmosphere of enthusiasm and team spirit.`,
    date: '',
    time: '',
    locationAr: 'ملاعب الجامعة',
    locationEn: 'University Courts',
    category: 'sports',
    capacity: 0,
    image: 'assets/images/image copy 9.png',
    isPast: true
  },
  {
    id: 40,
    titleAr: 'فريق كرة السلة',
    titleEn: 'Basketball Team',
    descAr: `فريق كرة السلة بجامعة الإسكندرية الأهلية، يجمع خيرة الطلاب في مختلف التخصصات، ويشارك بنشاط في البطولات الجامعية والإقليمية.`,
    descEn: `The basketball team at Alexandria National University brings together talented students from various specializations, actively participating in university and regional championships.`,
    date: '',
    time: '',
    locationAr: 'ملعب كرة السلة بالجامعة',
    locationEn: 'University Basketball Court',
    category: 'sports',
    capacity: 0,
  ...
  {
    id: 41,
    titleAr: 'فريق الكرة الطائرة',
    titleEn: 'Volleyball Team',
    descAr: `فريق الكرة الطائرة بجامعة الإسكندرية الأهلية، فريق متماسك يجمع بين الخبرة والشباب، يشارك في مختلف البطولات الجامعية باحترافية عالية.`,
    descEn: `The volleyball team at Alexandria National University, a cohesive team combining experience and youth, participating in various university championships with high professionalism.`,
    date: '',
    time: '',
    locationAr: 'ملعب الكرة الطائرة بالجامعة',
    locationEn: 'University Volleyball Court',
    category: 'sports',
    capacity: 0,
...
const galleryImages = [
  { thumb: 'assets/images/image copy.png', full: 'assets/images/image copy.png', titleAr: 'استقبال الطلبة الجدد', titleEn: 'New Student Orientation' },
  { thumb: 'assets/images/orientation day.jpg', full: 'assets/images/orientation day.jpg', titleAr: 'يوم الاستقبال والتعارف', titleEn: 'Orientation Day' },
  { thumb: 'assets/images/image copy 2.png', full: 'assets/images/image copy 2.png', titleAr: 'إفطار رمضان', titleEn: 'Ramadan Iftar' },
  { thumb: 'assets/images/image copy 3.png', full: 'assets/images/image copy 3.png', titleAr: 'أعمال خيرية في رمضان', titleEn: 'Ramadan Charity Work' },
  { thumb: 'assets/images/image copy 4.png', full: 'assets/images/image copy 4.png', titleAr: 'رحلة القاهرة', titleEn: 'Cairo Trip' },
  { thumb: 'assets/images/image copy 5.png', full: 'assets/images/image copy 5.png', titleAr: 'رحلة الفيوم', titleEn: 'Fayoum Trip' },
  { thumb: 'assets/images/image copy 6.png', full: 'assets/images/image copy 6.png', titleAr: 'فريق الجوالة', titleEn: 'Scouts Team' },
  { thumb: 'assets/images/image copy 7.png', full: 'assets/images/image copy 7.png', titleAr: 'بطولة تنس الطاولة', titleEn: 'Table Tennis Championship' },
  { thumb: 'assets/images/image copy 8.png', full: 'assets/images/image copy 8.png', titleAr: 'أسبوع الشباب في حلوان', titleEn: 'Youth Week in Helwan' },
  { thumb: 'assets/images/image copy 9.png', full: 'assets/images/image copy 9.png', titleAr: 'بطولة البادل', titleEn: 'Padel Championship' },
  { thumb: 'assets/images/image copy 10.png', full: 'assets/images/image copy 10.png', titleAr: 'فريق كرة السلة', titleEn: 'Basketball Team' },
  { thumb: 'assets/images/485792050_646359458329984_6980519911529053821_n.jpg', full: 'assets/images/485792050_646359458329984_6980519911529053821_n.jpg', titleAr: 'فريق الكرة الطائرة', titleEn: 'Volleyball Team' },
